...
export default class DeviceTableView {
    ...
    insertRowAtFirst(json) {
        ...
        //加上action列属性的值
        var td = document.createElement('td');
        var connectCondition = document.createElement('i')
        $(connectCondition).addClass('fa fa-link').addClass('weex_run_start_icon')
        $(td).append($(connectCondition))
